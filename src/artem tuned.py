...
def analyse_manual_data(pickle_file_name, mask_dir_path, red_dir_path, cfos_dir_path, result_path,
    ...
    data_dict[("summaryC 99_p_cfos_novel_image",)] = {"95_p_cfos_novel_image": np.mean(group_c_novel_99p_c_fos_list)}
    data_dict[("summaryD 99_p_cfos_novel_image",)] = {"95_p_cfos_novel_image": np.mean(group_d_novel_99p_c_fos_list)}
    data_dict[("summaryE 99_p_cfos_novel_image",)] = {"95_p_cfos_novel_image": np.mean(group_e_novel_99p_c_fos_list)}
    '''
