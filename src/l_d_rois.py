...
class ROI(GraphicsObject):
    ...
    **Arguments**
    ...
    removable        (bool) If True, the ROI will be given a context menu with
                     ...
                     Default is False.
    invisible_handle (bool), if True the handles won't be displayed
    alterable        (bool) if True, means we can move the handles
    no_seq_hover_action  (bool) means nothing change when the mouse is over a segment
    ================ ===========================================================
    ...
    **Signals**
    ...
    def hoverEvent(self, ev):
        ...
        if hover:
            ...
            self.roi_manager.hover_event_on_roi(pg_roi=self)
        else:
...
class MultiLineROI(MultiRectROI):
    def __init__(self, *args, **kwds):
        ...
        print(
            "Warning: MultiLineROI has been renamed to MultiRectROI. (and MultiLineROI may be redefined in the future)")
...
class PolygonROI(ROI):
    ## deprecated. Use PolyLineROI instead.
    ...
    **Arguments**
    ...
    def getArrayRegion(self, data, img, axes=(0, 1), order=1, **kwds):
        ...
        for i in range(len(imgPts) - 1):
            ...
            o = Point(imgPts[i])
            r = fn.affineSlice(data, shape=(int(d.length()),), vectors=[Point(d.norm())], origin=o, axes=axes,
                               order=order, **kwds)
            rgns.append(r)
